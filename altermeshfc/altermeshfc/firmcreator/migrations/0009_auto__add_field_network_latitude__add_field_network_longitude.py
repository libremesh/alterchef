...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Network.latitude'
        db.add_column('firmcreator_network', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Network.longitude'
        db.add_column('firmcreator_network', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Network.latitude'
        db.delete_column('firmcreator_network', 'latitude')

        # Deleting field 'Network.longitude'
        db.delete_column('firmcreator_network', 'longitude')
