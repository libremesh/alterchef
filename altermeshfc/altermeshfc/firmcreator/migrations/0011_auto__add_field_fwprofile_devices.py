...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FwProfile.devices'
        db.add_column('firmcreator_fwprofile', 'devices',
                      self.gf('django.db.models.fields.TextField')(default='TLWDR4300'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FwProfile.devices'
        db.delete_column('firmcreator_fwprofile', 'devices')
    ...
    models = {
        ...
        'firmcreator.fwprofile': {
            ...
            'devices': ('django.db.models.fields.TextField', [], {'default': "'TLWDR4300'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
