...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FwJob.creation_date'
        db.add_column('firmcreator_fwjob', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FwJob.creation_date'
        db.delete_column('firmcreator_fwjob', 'creation_date')
