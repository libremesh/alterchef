...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field admins on 'Network'
        db.create_table('firmcreator_network_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('network', models.ForeignKey(orm['firmcreator.network'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('firmcreator_network_admins', ['network_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field admins on 'Network'
        db.delete_table('firmcreator_network_admins')
    ...
    models = {
        ...
        'firmcreator.network': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'admins'", 'blank': 'True', 'to': "orm['auth.User']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
