...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FwProfile', fields ['slug']
        db.create_unique('firmcreator_fwprofile', ['slug'])

        # Adding unique constraint on 'Network', fields ['slug']
        db.create_unique('firmcreator_network', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Network', fields ['slug']
        db.delete_unique('firmcreator_network', ['slug'])

        # Removing unique constraint on 'FwProfile', fields ['slug']
        db.delete_unique('firmcreator_fwprofile', ['slug'])
